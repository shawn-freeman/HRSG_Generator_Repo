<%@ Page Title="Add Section" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="AddSection.aspx.cs" Inherits="HRSG_HandbookGenerator.Popups.AddSection" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="Main" runat="server">
    <div style="margin: 20px 20px 20px 20px;">
        ...
        <div style="margin: 10px 0px 0px 0px;" >
            <asp:Label runat="server" Font-Size="12pt" Text="Enter the Section content in the box below: " ></asp:Label>
